...
/**
 * @title DeployBase
 * @notice Shared base contract for wrapper deployment scripts.
 * @dev Provides RLP-based CREATE address computation needed to pre-approve
 *      seed liquidity to the not-yet-deployed wrapper contract.
 */
